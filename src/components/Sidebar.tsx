          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu className="space-y-4">
                ...
                {user.role === 'superuser' && (
                  ...
                  <NavLink to="/riwayat-saldo-rekening">
                    ...
                    >
                      ...
                      <span className="font-medium">Riwayat Saldo Rekening</span>
                      {location.pathname === "/riwayat-saldo-rekening" && (
                        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-gradient-to-b from-blue-400 to-indigo-500 rounded-r-full" />
                      )}
                    </SidebarMenuButton>
                  </NavLink>
                ...
                {user?.role === 'superuser' && (
                  <SidebarMenuItem>
                    <NavLink to="/saldo-harian-rekening">
                      <SidebarMenuButton
                        isActive={location.pathname === "/saldo-harian-rekening"}
                        className={cn(
                          "group relative rounded-xl px-4 py-4 text-slate-300 hover:text-white transition-all duration-300",
                          "hover:bg-gradient-to-r hover:from-blue-600/20 hover:to-indigo-600/20",
                          "hover:shadow-lg hover:shadow-blue-500/10",
                      ...
                      >
                        ...
                        <span className="font-medium">Saldo Harian Rekening</span>
                        {location.pathname === "/saldo-harian-rekening" && (
                          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-gradient-to-b from-blue-400 to-indigo-500 rounded-r-full" />
                        )}
                      </SidebarMenuButton>
                    </NavLink>
                ...
                {user?.role === 'superuser' && (
                  <SidebarMenuItem>
                    <NavLink to="/saldo-harian-generator">
                      <SidebarMenuButton
                        isActive={location.pathname === "/saldo-harian-generator"}
                        className={cn(
                          "group relative rounded-xl px-4 py-4 text-slate-300 hover:text-white transition-all duration-300",
                          "hover:bg-gradient-to-r hover:from-blue-600/20 hover:to-indigo-600/20",
                          "hover:shadow-lg hover:shadow-blue-500/10",
