...
export interface IRiwayatSaldoRekening extends Document {
  ...
  ref_type?: 'TT_FINANCE_DETAIL' | 'PERJALANAN_DANA' | 'TRANSFER_REKENING' | 'ASSET_TRANSFER';
...
const RiwayatSaldoRekeningSchema: Schema = new Schema({
  ...
  ref_type: { type: String, enum: ['TT_FINANCE_DETAIL', 'PERJALANAN_DANA', 'TRANSFER_REKENING', 'ASSET_TRANSFER'], required: false },
